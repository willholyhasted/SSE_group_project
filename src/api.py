...
if response.status_code == 200:
    ...
    for entry in root.findall('atom:entry', namespaces):
        ...
        event_link = event_link.attrib['href'] if event_link is not None else 'No link available'
        ...
        if isinstance(formatted_start_date, datetime) and isinstance(formatted_end_date, datetime):
